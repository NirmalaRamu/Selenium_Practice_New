...
public class XLUtils 
{
	...
	public static int getRowCount(String xlfile,String xlsheet) throws IOException
	{
		...
		return rowcount;
		// return should be the last argument of any method or class
	}	
	...
	public static String getStringCellData(String xlfile,String xlsheet,int rownum,int colcount) throws IOException
	{
		fi = new FileInputStream(xlfile);
		wb = new XSSFWorkbook(fi);
		ws = wb.getSheet(xlsheet);
